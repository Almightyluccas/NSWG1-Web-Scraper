...
export class RaidSchedule {
    private static RAID_TIMES: RaidTime[] = [
        { dayOfWeek: 3, hour: 21, minute: 0, durationMinutes: 180 }, // Wednesday 9 PM EST for 3 hours
        { dayOfWeek: 6, hour: 21, minute: 0, durationMinutes: 180 }  // Saturday 9 PM EST for 3 hours
    ];
